    ...
    <div className="flex items-center gap-2 flex-wrap">
      {activeBuffs.map((buff, index) => (
        <Badge 
          key={index}
          variant="outline" 
          className="border-blue-400/50 text-blue-300 font-orbitron text-xs"
      ...
      {activeDebuffs.map((debuff, index) => (
        <Badge 
          key={index}
          variant="outline" 
          className="border-red-400/50 text-red-300 font-orbitron text-xs"
                  ...
                  {activeBuffs.map((buff, index) => (
                    <div key={index} className="p-3 bg-blue-500/10 rounded-lg border border-blue-500/20 mb-2">
                      <div className="flex justify-between items-center mb-1">
                        <span className="font-orbitron font-bold text-blue-300">{buff.name}</span>
                ...
                <div>
                  ...
                  {activeDebuffs.map((debuff, index) => (
                    <div key={index} className="p-3 bg-red-500/10 rounded-lg border border-red-500/20 mb-2">
                      <div className="flex justify-between items-center mb-1">
                        <span className="font-orbitron font-bold text-red-300">{debuff.name}</span>
